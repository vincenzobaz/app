...
export const QuestionsModal = React.createClass({
  ...
  questionToStep(question) {
    ...
    if (!Question.getQuestionFromType(kind)) {
    ...
    return React.createElement(this.getQuestionComponentFromType(kind), question);
  },

  getQuestionComponentFromType(kind) {
    switch (kind) {
...
export const Done = React.createClass({
...
export const TimeUp = React.createClass({
